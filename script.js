...
function updateAboutPageLang(lang) {
  ...
  const translations = {
    ...
    en: {
      ...
      story1: 'Alicia Spelberg was born into a musical family. Music played a leading role for generations. Alicia inherited an impressive collection of music books and precious experiences with her family, and built a life dedicated to music of her own.',
